...
// gestion des listes à afficher 

// affichage liste en stock 
const enStock = pieces.map(piece => piece.nom + " - " + piece.prix + "€");
...
for(let i=0; i < enStock.length ; i++){
   ...
   nomElement.innerText = enStock[i];
   enStockElements.appendChild(nomElement)
}
// Ajout de l'en-tête puis de la liste au bloc résultats filtres
document.querySelector('.enStock').appendChild(enStockElements)


// affichage liste abordable
